                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="card card-user">
                                        ...
                                        <div class="card-body">
                                            <div class="author">
                                            <a href="{{url('/getUniversityProgramsSpecific')}}?id={{$program->ProgramId}}">
                                                    <img class="avatar border-gray" src="img/logos/programs/{{$program->Logo}}" alt="...">
                                                    <h3 class="title">{{$program->ProgramName}}</h3>
                                                </a>
                                                <p class="description">
